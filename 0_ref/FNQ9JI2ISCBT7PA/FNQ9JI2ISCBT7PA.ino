...
byte sensors[][8] = {
   { 0x28, 0xFF, 0x92, 0xCB, 0x00, 0x17, 0x03, 0xB1 },
   { 0x28, 0xFF, 0xCE, 0xA1, 0x00, 0x17, 0x03, 0x8E }
};
...
OneWire  ds(0);  // on pin 0 (a 4.7K pullup is necessary)
